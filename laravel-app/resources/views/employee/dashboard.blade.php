    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
        ...
        <div class="card animate-fade-in delay-2">
            ...
            <div class="card-body" style="display: flex; gap: 1rem; flex-wrap: wrap;">
                ...
                <button type="button" class="btn btn-outline" style="flex-grow: 1; color: var(--danger); border-color: rgba(239, 68, 68, 0.2); background: rgba(239, 68, 68, 0.05);" onclick="alert('Please contact your HR Administrator directly or send an official email to process a formal resignation.')">
