...
return [
    ...
    */
    ...
    | is set to "Asia/Jakarta" for Indonesian Western Time (WIB).
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This key is utilized by Laravel's encryption service and should be set
    ...
    */
    ...
    | be loaded to conveniently access their facades.
    |
    */
